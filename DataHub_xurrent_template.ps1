...
$DataHub_baseURL = $env:DataHub_baseURL
$DataHub_URL = "$DataHub_baseURL/v1/resultDatabase/table/$DataHub_Table"
...
$4me_Account = $env:Xurrent_Account
